    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Forget Password(Coming Soon)</a>
                    </li>
                </ul>
        ...
        <form action="ServletController" method="POST">
            <div class="container">
                ...
                <hr>
                <c:set var="errorDuplicate" value="${requestScope.DUPLICATE}"/>
                <c:set var="errorPwd" value="${requestScope.ERRORPWD}"/>

                <c:if test="${not empty errorDuplicate}">
                    <label for="email"><b>Email</b></label>
                    <input style="border: 2px red solid;" type="email" placeholder="Enter Email" name="userID" value="${param.userID}" id="email" required>
                    <h2 style="color: red;margin-top: -10px;">${errorDuplicate}</h2>

                </c:if>
                <c:if test="${empty errorDuplicate}">
                    <label for="email"><b>Email</b></label>
                ...
                <c:if test="${not empty errorPwd}">
                    ...
                    <h2 style="color: red;margin-top: -10px;">${errorPwd}</h2>

                </c:if>

                <hr>
                <button type="submit" name="btAction" value="Register" class="registerbtn">Register</button>
            </div>
